...
/// Encrypt the user inputted password with Bxryption method
///
/// #Example
/// when a user logges in, his input is like this ,
/// ```
/// // user inputed data
/// {
...
/// {
///     "email":"user@gmail.com"
///     "password";"ljd0rrn3ous0werj30rXXXXXXXXXX..."
/// }
/// ```
pub async fn hash_password(password: String) -> String {
    ...
    rayon::spawn(move || {
        // rayon is used for sequential work in parrallismly --- > https://crates.io/crates/rayon
...
/// here we are taking , the password which comes fromm LoginInput, and the hash_password(Encrypted) from Database and match them, if they are verified or not
